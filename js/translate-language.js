        ...
        fetch(`/assets/locales/${language}.json`)
            ...
            .then(data => {
                ...
                const elementsMap = {
                    ...
                    '.banner-promo-text': data['banner']['banner-promo-text'],
                    ...
                    '.settings-card-title': data.settings['settings-card-title'],
                    '.settings-card-firstname': data.settings['settings-card-firstname'],
                    ...
                    '.pixelfps_button': data['promo-modal']['pixelfps_button'],
                    '.upgrade_title': data['promo-modal']['upgrade_title'],
                    '.upgrade_descr': data['promo-modal']['upgrade_descr'],
                    '.upgrade_button': data['promo-modal']['upgrade_button'],
                    '.aboutcompany-text': data["aboutcompany-text"],
                    '#user-agreement-btn .btn-useragreement-text': data["user-agreement-btn"],
                    '#privacy-policy-btn .btn-privacy-text': data["privacy-policy-btn"],
                ...
                if (genderSelect && data.settings && data.settings.gender) {
                    genderSelect.options[0].textContent = data.settings.gender.select || "Select gender";
