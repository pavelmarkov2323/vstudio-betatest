        ...
        fetch(`/assets/locales/${language}.json`)
            ...
            .then(data => {
                ...
                const elementsMap = {
                    ...
                    '.promotitle_pixelfps': data['promo-modal']['promotitle_pixelfps'],
                    '.promodiscr_pixelfps': data['promo-modal']['promodiscr_pixelfps'],
                    '.promo-button_buy': data['promo-modal']['promo-button_buy'],
